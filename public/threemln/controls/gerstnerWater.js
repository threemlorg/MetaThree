...
import { Water } from 'https://cdn.skypack.dev/three@0.135.0/examples/jsm/objects/Water'
...
export default class GerstnerWater {
    ...
    constructor(waveScale, steepness, speed, waterColor = 0x001e0f, sunDirection=new THREE.Vector3()) {
        this.speed = speed;
        const waterGeometry = new THREE.PlaneGeometry(4096, 4096, 256, 256)
        this.texture = new THREE.TextureLoader().load('/threeml/images/waternormals.jpg', function (texture) {
            texture.wrapS = texture.wrapT = THREE.RepeatWrapping
        })

        this.waves = [
            { direction: 0, steepness: 0.15 * steepness, wavelength: 100 * waveScale },
            { direction: 30, steepness: 0.15 * steepness, wavelength: 50 * waveScale },
            { direction: 60, steepness: 0.15 * steepness, wavelength: 25 * waveScale },
        ]
